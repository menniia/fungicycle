            ...
            <div className="container mx-auto px-4">
                <div className="max-w-2xl mx-auto">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-green-600 text-white px-6 py-3 rounded-md font-medium inline-flex items-center justify-center hover:text-gray-700 transition-colors"
                        >
                            Send Message
